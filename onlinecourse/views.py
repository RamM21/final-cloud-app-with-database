...
def submit(request, course_id):
    ...
    choises = extract_answers(request)
    submission.choices = choises
    return HttpResponseRedirect(viewname='show_exam_result',args=(submission,))
...
def show_exam_result(request, course_id, submission_id):
    ...
    context={'course':course_id,'selected_id':[choices],'grade':score}
